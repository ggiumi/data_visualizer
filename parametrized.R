...
createPCAPlot <- function(dds) {
  ...
  # Perform PCA and return the data with the percentage of variance explained
  pca_data <- plotPCA(vst_data, intgroup = "tissues_subtype", returnData = TRUE)
  
  # Calculate the percentage of variance explained
  percentVar <- round(100 * attr(pca_data, "percentVar"))
  
  # Create the PCA plot with the percentage of variance in the axis labels
